...
Gaussian process driving input single input motif model:
  ...
  Basal transcription rate:
    Gene 1: 38.6975085329924
    Gene 2: 0.00778721698069121
    Gene 3: 7.57478615699329e-07
  Kernel:
    Multiple output block kernel:
    Block 1
    Normalised version of the kernel.
    RBF inverse width: 0.7717748 (length scale 1.138295)
    RBF variance: 1.754264
    Block 2
    Normalised version of the kernel
    DISIM decay: 0.07300767
    DISIM inverse width: 0.7717748 (length scale 1.138295)
    DISIM Variance: 1
    SIM decay: 2463.444
    SIM Variance: 0.001469411
    RBF Variance: 1.754264
    Block 3
    Normalised version of the kernel
    DISIM decay: 0.07300767
    ...
    DISIM inverse width: 0.7717748 (length scale 1.138295)
    DISIM Variance: 1
    SIM decay: 0.0001251229
    SIM Variance: 0.003265721
    RBF Variance: 1.754264
  Log-likelihood: -31.83748 
\end{Soutput}
\end{Schunk}
...
"147995_at" 6.75970990320143 -487.893231050121
"152715_at" -1.48249964194197 -539.73619673943
"148227_at" -1.55674194211824 -73.4806804255218
\end{Soutput}
\end{Schunk}
...
Gaussian process driving input single input motif model:
  ...
  Target genes (1):
    147995_at
  Basal transcription rate:
    Gene 1: 0.000134939004780641
  Kernel:
    Multiple output block kernel:
    Block 1
    Normalised version of the kernel.
    RBF inverse width: 0.7602656 (length scale 1.146878)
    RBF variance: 1.804697
    Block 2
    Normalised version of the kernel
    DISIM decay: 0.01796942
    DISIM inverse width: 0.7602656 (length scale 1.146878)
    DISIM Variance: 1
    SIM decay: 0.01949134
    SIM Variance: 0.002723638
    RBF Variance: 1.804697
  Log-likelihood: 6.75971 
\end{Soutput}
\end{Schunk}
...
\begin{Soutput}
"log-likelihood" "null_log-likelihood"
"152715_at" -28.1301056131502 -539.73619673943
"147995_at" -207.229260597104 -487.893231050121
\end{Soutput}
\end{Schunk}
