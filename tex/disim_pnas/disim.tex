...
time (``signle-target models'').  The candidate targets were ranked by
...
\begin{figure}[htb]
  ...
  \caption{Global evaluation results of different rankings as
    ...
    frequency of predicted targets with significant differential
...
\begin{materials}
  ...
  (\sigma^f_{ij})^2$) of absolute expression by minimizing the squared
  ...
  knowledge of known targets should be utilized.  To speed up the
