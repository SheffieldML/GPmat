...
characterised by a mean and variance, the Gaussian process is
...
Drosophila~\cite{Sandmann2007}. We used a microarray dataset
...
case where the TF is activated post-transcription and they therefore
...
problem of dealing with TFs activated post-transcription. This
...
to single input motif models, but many target will be regulated by other TFs and
