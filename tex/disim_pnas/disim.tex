...
\begin{materials}
  ...
  $\left(\hat{m_i}(t_j), \hat{f_i}(t_j)\right)$ and variances $\left((\sigma_{ijm})^2,
  ...
  $$ \frac{1}{Rn} \sum_{r=1}^R \sum_{i=1}^n \frac{\hat{m_{jr}}(t_i)}{\sigma_{ijr}} < 1.8 $$
  ...
  \begin{multline*}
    ...
    -
    \exp\left(\left(\gamma_\delta\right)^2 + \delta \Delta t\right)
...
A.H. was supported by a postdoctoral researcher's project No 121179 of the Academy of Finland.
