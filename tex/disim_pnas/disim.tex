...
\begin{abstract}
  ...
  transcription factors controlling mesoderm development in {\it Drosophila}. Lists of top-ranked
  ...
  loss-of-function mutants. Our approach is superior to
...
Another example with a better-defined TF is shown in
Fig.~\ref{fig:gpdisim_mef2_models}.  In this case most of the
top-ranking targets are very similar to the first two from the left.
