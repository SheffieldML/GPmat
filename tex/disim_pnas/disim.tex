...
points. We sub-sampled the data keeping only 7 time points
(2,3,4,5,6,8,10 hours). The results in this case are almost identical
(see Supplementary Material) showing that the model-based approach
presented here can be applied to typical short wild-type time series
data.
