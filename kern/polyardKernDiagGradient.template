 function g = polyardKernDiagGradient(kern, x, covDiag)

% POLYARDKERNDIAGGRADIENT Compute the gradient of the POLYARD kernel's diagonal wrt parameters.
% FORMAT
% DESC computes the gradient of functions of the diagonal of the
% automatic relevance determination polynomial kernel matrix with respect to the parameters of the kernel. The
% parameters' gradients are returned in the order given by the
% polyardKernExtractParam command.
...
% polyardKernExtractParam.
%
% SEEALSO : polyardKernParamInit, kernDiagGradient, polyardKernExtractParam, polyardKernGradient
%
