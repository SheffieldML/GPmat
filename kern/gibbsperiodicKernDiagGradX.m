...
% FORMAT
% DESC computes the gradient of the diagonal of the Gibbs-kernel derived periodic kernel matrix with
...
%
% SEEALSO : gibbsperiodicKernParamInit, kernDiagGradX, gibbsperiodickernGradX
%
