...
lnPart1 = log(erf(real(invSigmaDiffT - halfSigmaD_i)) ...
              + erf(real(t2Mat/sigma + halfSigmaD_i)));
lnPart2 = log(erf(real(t1Mat/sigma - halfSigmaD_i)) ...
              + erf(real(halfSigmaD_i)));
warning(warnState.state, 'MATLAB:log:logOfZero');
h = exp(halfSigmaD_i*halfSigmaD_i-D_i*diffT+lnPart1...
             - log(D_i + D_j)) ...
         - exp(halfSigmaD_i*halfSigmaD_i-D_i*t1Mat-D_j*t2Mat ...
               + lnPart2 ...
               - log(D_i + D_j));
sigma2 = sigma*sigma;
