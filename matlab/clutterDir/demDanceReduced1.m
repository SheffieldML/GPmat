% DEMDANCEREDUCED1 Model the dance man using an RBF kernel and dynamics.
...
dynKern.comp{1}.inverseWidth = 14;
% This gives signal to noise of 0.1:1e-3 or 100:1.
dynKern.comp{1}.variance = 0.5^2;
