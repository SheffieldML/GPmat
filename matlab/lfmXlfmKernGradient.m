...
if isreal(omega)
    ...
    matGrad = (prod(S)*sqrt(pi)/(4*prod(m)*prod(omega))) ...
        * real(lfmComputeH(conj(gamma2),gamma1,sigma2,Tt1,Tt2) ...
        ...
        - lfmComputeH(gamma2,gamma1,sigma2,Tt1,Tt2) ...
        - lfmComputeH(gamma1,gamma2,sigma2,Tt2,Tt1) ...
        + sigma*(lfmGradientSigmaH(conj(gamma2),gamma1,sigma2,Tt1,Tt2) ...
        + lfmGradientSigmaH(gamma1,conj(gamma2),sigma2,Tt2,Tt1) ...
        - lfmGradientSigmaH(gamma2,gamma1,sigma2,Tt1,Tt2) ...
        - lfmGradientSigmaH(gamma1,gamma2,sigma2,Tt2,Tt1)));
else
    gamma1_p = alpha(1) + j*omega(1);
    gamma1_m = alpha(1) - j*omega(1);
    gamma2_p = alpha(2) + j*omega(2);
    ...
    matGrad = (prod(S)*sqrt(pi)/(8*prod(m)*prod(omega))) ...
       * (lfmComputeH(gamma2_m,gamma1_p,sigma2,Tt1,Tt2) ...
       ...
       - lfmComputeH(gamma2_p,gamma1_p,sigma2,Tt1,Tt2) ...
       - lfmComputeH(gamma1_p,gamma2_p,sigma2,Tt2,Tt1) ...
       + sigma*(lfmGradientSigmaH(gamma2_m,gamma1_p,sigma2,Tt1,Tt2) ...
       + lfmGradientSigmaH(gamma1_p,gamma2_m,sigma2,Tt2,Tt1) ...
       + lfmGradientSigmaH(gamma2_p,gamma1_m,sigma2,Tt1,Tt2) ...
       + lfmGradientSigmaH(gamma1_m,gamma2_p,sigma2,Tt2,Tt1) ...
       - lfmGradientSigmaH(gamma2_m,gamma1_m,sigma2,Tt1,Tt2) ...
       - lfmGradientSigmaH(gamma1_m,gamma2_m,sigma2,Tt2,Tt1) ...
       - lfmGradientSigmaH(gamma2_p,gamma1_p,sigma2,Tt1,Tt2) ...
       - lfmGradientSigmaH(gamma1_p,gamma2_p,sigma2,Tt2,Tt1)));
end;
