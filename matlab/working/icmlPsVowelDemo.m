% ICMLPSVOWELDEMO Try the point sets IVM for classification of vowels.
...
for dVal = [100 200 300 400 500 700]; 
  ...
  for testSpeaker = 1:numSpeakers
    ...
    save(['icmlPsVowel_d' num2str(dVal) '_seed' num2str(seed)], 'confusMat', 'perCentCorrect', 'time')
  end
end