...
% force model kernel corresponding to the velocities given inputs 
...
% kernel corresponding to the velocities given a design matrix of inputs.
% ARG kern : the kernel structure for which the matrix is computed.
% ARG t : input data matrix in the form of a design matrix.
% ARG covIC : covariance for the initial conditions
% RETURN k : the kernel matrix computed at the given points.
%
% SEEALSO : sdlfmKernParamInit, kernCompute, kernCreate, sdlfmKernDiagCompute
%
