...
% RETURN k : block of values from kernel matrix.
%
% SEEALSO : multiKernParamInit, multiKernCompute, lfmKernParamInit
%
...
if isreal(omega)
  ...
  K = sigma*lfmKern1.sensitivity*lfmKern2.sensitivity* ...
        real(lfmComputeH(conj(gamma2),gamma1,sigmai,t,t2) + ...
             transpose(lfmComputeH(gamma1,conj(gamma2),sigmai,t2,t)) - ...
             lfmComputeH(gamma2,gamma1,sigmai,t,t2) - ...
             transpose(lfmComputeH(gamma1,gamma2,sigmai,t2,t)));
  ...
  sigmai = sigma2;
  K = sigma*lfmKern1.sensitivity*lfmKern2.sensitivity* ...
        (lfmComputeH(gamma2_m,gamma1_p,sigmai,t,t2) + ...
         transpose(lfmComputeH(gamma1_p,gamma2_m,sigmai,t2,t)) + ...
         lfmComputeH(gamma2_p,gamma1_m,sigmai,t,t2) + ...
         transpose(lfmComputeH(gamma1_m,gamma2_p,sigmai,t2,t)) - ...
         lfmComputeH(gamma2_m,gamma1_m,sigmai,t,t2) - ...
         transpose(lfmComputeH(gamma1_m,gamma2_m,sigmai,t2,t)) - ...
         lfmComputeH(gamma2_p,gamma1_p,sigmai,t,t2) - ...
         transpose(lfmComputeH(gamma1_p,gamma2_p,sigmai,t2,t)));
