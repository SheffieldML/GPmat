...
if isreal(omega)
  ...
  K = sigma*lfmKern1.sensitivity*lfmKern2.sensitivity* ...
        real(lfmComputeH(conj(gamma2),gamma1,sigma2,Tt1,Tt2) + ...
             lfmComputeH(gamma1,conj(gamma2),sigma2,Tt2,Tt1) - ...
             lfmComputeH(gamma2,gamma1,sigma2,Tt1,Tt2) - ...
             lfmComputeH(gamma1,gamma2,sigma2,Tt2,Tt1));
  ...
  K = sigma*lfmKern1.sensitivity*lfmKern2.sensitivity* ...
        (lfmComputeH(gamma2_m,gamma1_p,sigma2,Tt1,Tt2) + ...
         lfmComputeH(gamma1_p,gamma2_m,sigma2,Tt2,Tt1) + ...
         lfmComputeH(gamma2_p,gamma1_m,sigma2,Tt1,Tt2) + ...
         lfmComputeH(gamma1_m,gamma2_p,sigma2,Tt2,Tt1) - ...
         lfmComputeH(gamma2_m,gamma1_m,sigma2,Tt1,Tt2) - ...
         lfmComputeH(gamma1_m,gamma2_m,sigma2,Tt2,Tt1) - ...
         lfmComputeH(gamma2_p,gamma1_p,sigma2,Tt1,Tt2) - ...
         lfmComputeH(gamma1_p,gamma2_p,sigma2,Tt2,Tt1));
