...
K = sigma*lfmKern1.sensitivity*lfmKern2.sensitivity* ...
    real(lfmComputeH(conj(gamma2),gamma1,sigma2,t1,t2,1) + ...
    lfmComputeH(gamma1,conj(gamma2),sigma2,t2,t1, 2) - ...
    lfmComputeH(gamma2,gamma1,sigma2,t1,t2,1) - ...
    lfmComputeH(gamma1,gamma2,sigma2,t2,t1,2));
K = K*sqrt(pi)/(4*lfmKern1.mass*lfmKern2.mass*prod(omega));
  ...
  K = sigma*lfmKern1.sensitivity*lfmKern2.sensitivity* ...
        (lfmComputeH(gamma2_m,gamma1_p,sigma2,t1,t2,1) + ...
         lfmComputeH(gamma1_p,gamma2_m,sigma2,t2,t1,2) + ...
         lfmComputeH(gamma2_p,gamma1_m,sigma2,t1,t2,1) + ...
         lfmComputeH(gamma1_m,gamma2_p,sigma2,t2,t1,2) - ...
         lfmComputeH(gamma2_m,gamma1_m,sigma2,t1,t2,1) - ...
         lfmComputeH(gamma1_m,gamma2_m,sigma2,t2,t1,2) - ...
         lfmComputeH(gamma2_p,gamma1_p,sigma2,t1,t2,1) - ...
         lfmComputeH(gamma1_p,gamma2_p,sigma2,t2,t1,2));
