...
X = [randn(dataPerCat,2)-[zeros(dataPerCat, 1) 18*ones(dataPerCat, 1)]; ...
     randn(dataPerCat,2)-[zeros(dataPerCat, 1) 12*ones(dataPerCat, 1)]; ...
     randn(dataPerCat,2)-[zeros(dataPerCat, 1) 6*ones(dataPerCat, 1)]; ...
     randn(dataPerCat, 2); ...
     randn(dataPerCat,2)+[zeros(dataPerCat, 1) 6*ones(dataPerCat, 1)]; ...
     randn(dataPerCat,2)+[zeros(dataPerCat, 1) 12*ones(dataPerCat, 1)]; ...
     randn(dataPerCat,2)+[zeros(dataPerCat, 1) 18*ones(dataPerCat, 1)]];
