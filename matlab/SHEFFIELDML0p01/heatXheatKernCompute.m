...
%	Description:
%
%	[K, SK, SKIC] = HEATXHEATKERNCOMPUTE(HEATKERN1, HEATKERN2, X1)
%	computes cross kernel terms between two HEAT kernels for the
...
%
%	[K, SK, SKIC] = HEATXHEATKERNCOMPUTE(HEATKERN1, HEATKERN2, X1, X2)
%	computes cross kernel terms between two HEAT kernels for the
%	multiple output kernel.
%	 Returns:
%	  K - block of values from kernel matrix.
