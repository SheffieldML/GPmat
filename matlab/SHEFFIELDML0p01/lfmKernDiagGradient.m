...
%	Description:
%
%	G = LFMKERNDIAGGRADIENT(LFMKERN, T, FACTORS) computes the gradient
%	of functions of the diagonal of the single input motif kernel matrix
...
%	   lfmKernExtractParam.
%	 Arguments:
%	  LFMKERN - the kernel structure for which the gradients are
%	   computed.
%	  T - the input data for which the gradient is being computed.
