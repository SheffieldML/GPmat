...
%	Description:
%
%	[G1, G2, COVGRAD] = SDLFMXSDLFMKERNGRADIENT(SDLFMKERN1, SDLFMKERN2,
%	T1, COVGRAD, COVIC) computes a cross gradient for a cross kernel
%	between two switching dynamical LFM kernels for the multiple output
%	kernel.
%	 Returns:
...
%	   see lfmKernExtractParam.
%	  COVGRAD - partial covariances for kyy(t_0, t_0), kyv(t_0,t_0),
%	   kvy(t_0,t_0) and kvv(t_0,t_0).
%	 Arguments:
%	  SDLFMKERN1 - the kernel structure associated with the first SDLFM
%	   kernel.
...
%
%	[G1, G2, COVGRAD] = SDLFMXSDLFMKERNGRADIENT(SDLFMKERN1, SDLFMKERN2,
%	T1, T2, COVGRAD, COVIC) computes a cross gradient for a cross kernel
%	between two switching dynamical LFM kernels for the multiple output
%	kernel.
%	 Returns:
%	  G1 - gradient of the parameters of the first kernel, for ordering
...
%
%	[G1, G2, COVGRAD] = SDLFMXSDLFMKERNGRADIENT(SDLFMKERN1, SDLFMKERN2,
%	T1, T2, COVGRAD, COVIC, TYPE) computes a cross gradient for a cross
%	kernel between two switching dynamical LFM kernels for the multiple
%	output kernel. SDLFM kernels can correspond to Position X Position
%	(default), Velocity X Position, Velocity X Velocity, Acceleration X
%	Position, Acceleration X Velocity, Acceleration X Acceleration. The
%	type of kernel for which the gradients are obtained is specified in
%	'type'.
%	 Returns:
%	  G1 - gradient of the parameters of the first kernel, for ordering
%	   see lfmKernExtractParam.
...
%	   elements of the cross kernel matrix.
%	  COVIC - covariance for the initial conditions
%	  TYPE - specifies the type of kernel to be computed
%	
%
%	See also
