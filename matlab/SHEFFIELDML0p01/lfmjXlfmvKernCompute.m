function K = lfmjXlfmvKernCompute(lfmKern1, lfmKern2, t1, t2)

% LFMJXLFMVKERNCOMPUTE Jolt and velocity LFM kernel
%
%	Description:
%
%	K = LFMJXLFMVKERNCOMPUTE(LFMKERN1, LFMKERN2, T) computes cross
%	kernel terms between jolt and velocity LFM kernels.
%	 Returns:
...
%
%	K = LFMJXLFMVKERNCOMPUTE(LFMKERN1, LFMKERN2, T1, T2) computes cross
