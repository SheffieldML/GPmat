function K = lfmaXlfmKernCompute(lfmKern1, lfmKern2, t1, t2)

% LFMAXLFMKERNCOMPUTE Acceleration and position LFM kernel
%
%	Description:
%
%	K = LFMAXLFMKERNCOMPUTE(LFMKERN1, LFMKERN2, T) computes cross kernel
%	terms between acceleration and position LFM kernels.
%	 Returns:
...
%
%	K = LFMAXLFMKERNCOMPUTE(LFMKERN1, LFMKERN2, T1, T2) computes cross
