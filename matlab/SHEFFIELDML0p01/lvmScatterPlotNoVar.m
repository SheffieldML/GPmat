...
%	Description:
%
%	AX = LVMSCATTERPLOTNOVAR(MODEL) This version of lvmScatterPlot
%	doesn't visualize the variance which can sometimes save time in
%	plotting. produces a visualisation of the latent space with the
%	given model.
%	 Returns:
...
%	With modifications by Andreas Damianou 2012
