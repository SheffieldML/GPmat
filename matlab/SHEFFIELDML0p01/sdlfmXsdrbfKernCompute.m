...
%	Description:
%
%	[K, KC] = SDLFMXSDRBFKERNCOMPUTE(SDLFMKERN, SDRBFKERN, T) computes
...
%	 Returns:
%	  K - block of values from kernel matrix. K is a cell where the
%	   number of cells is related to the number of latent forces per
%	   interval
...
%
%	[K, KC] = SDLFMXSDRBFKERNCOMPUTE(SDLFMKERN, SDRBFKERN, T1, T2)
%	computes cross kernel terms between a SDLFM and a SDRBF kernels for
...
%
%	[K, KC] = SDLFMXSDRBFKERNCOMPUTE(SDLFMKERN, SDRBFKERN, T1, T2, TYPE)
%	computes cross kernel terms a SDLFM and a SDRBF kernels for the
%	multiple output kernel. The SDLFM kernel can correspond to Position
%	(default), Velocity or Acceleration. The type of kernel to be
%	computed is specified in 'type'.
%	 Returns:
%	  K - block of values from kernel matrix. K is a cell where the
%	   number of cells is related to the number of latent forces per
%	   interval
