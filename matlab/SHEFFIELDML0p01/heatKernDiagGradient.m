...
%	Description:
%
%	G = HEATKERNDIAGGRADIENT(KERN, X, FACTORS) computes the gradient of
%	functions of the diagonal of the heat kernel matrix with respect to
%	the parameters of the kernel. The parameters' gradients are returned
%	in the order given by the heatKernExtractParam command.
%	 Returns:
...
%	  X - the input times for which the gradient is being computed.
%	  FACTORS - partial derivatives of the function of interest with
%	   respect to the diagonal elements of the kernel.
%	
%
%	See also
%	HEATKERNPARAMINIT, KERNDIAGGRADIENT, HEATKERNEXTRACTPARAM
