...
%	Description:
%
%	[G1, G2] = LFMVXRBFKERNGRADIENT(LFMKERN, RBFKERN, T) computes the
%	gradient of an objective function with respect to cross kernel terms
%	between LFMV and RBF kernels for the multiple output kernel.
%	 Returns:
...
%
%	[G1, G2] = LFMVXRBFKERNGRADIENT(LFMKERN, RBFKERN, T1, T2) computes
%	the gradient of an objective function with respect to cross kernel
%	terms between LFMV and RBF kernels for the multiple output kernel.
%	 Returns:
%	  G1 - gradient of objective function with respect to kernel
%	   parameters of LFMV kernel.
%	  G2 - gradient of objective function with respect to kernel
...
%
%	[G1, G2] = LFMVXRBFKERNGRADIENT(LFMKERN, RBFKERN, T1, T2, MEANVEC)
