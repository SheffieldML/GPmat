function [g1, g2, g3] = sdlfmaXsdlfmaKernGradientBlockIGJ(lfmKern1, lfmKern2, ...
...
%	T1, T2, COVGRAD, G1MEAN, G2MEAN, GSP1MEAN, GSP2MEAN, TYPEMEANPARAM,
%	TYPEMEANSWITCHING, TYPEKERNPARAM1, TYPEKERNPARAM2,
%	TYPEKERNSWITCHING1, TYPEKERNSWITCHING2) computes the gradients of
%	the parameters for system 1 and system 2 when i is greater than j.
%	It assummes both systems represent accelerations.
%	 Returns:
...
%	   obtained from the part of the function that uses the funcitons
%	   accommpanying the initial conditions.
%	  TYPEMEANPARAM - specify the mean functions used to compute this
%	   part of the kernel
%	  TYPEMEANSWITCHING - specify the functions used to compute the
%	   gradients of the swicthing points in part thst uses mean functions
%	  TYPEKERNPARAM1 - specify the first kernel function used to compute
%	   this part of the kernel
%	  TYPEKERNPARAM2 - specify the second kernel function used to
%	   compute this part of the kernel
%	  TYPEKERNSWITCHING1 - specify the functions used to compute the
%	   gradients of the swicthing points in both sides of the kernel
%	   function 1
%	  TYPEKERNSWITCHING2 - specify the functions used to compute the
%	   gradients of the swicthing points in both sides of the kernel
%	   function 2
