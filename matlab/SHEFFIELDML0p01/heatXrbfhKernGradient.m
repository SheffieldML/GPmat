...
%	Description:
%
%	[G1, G2] = HEATXRBFHKERNGRADIENT(HEATKERN, RBFKERN, X1, COVGRAD)
%	computes the gradients wrt parameters of a cross kernel term between
...
%
%	[G1, G2] = HEATXRBFHKERNGRADIENT(HEATKERN, RBFKERN, X1, X2, COVGRAD)
%	computes the gradients wrt parameters of a cross kernel term between
%	a HEAT kernel and a RBFH kernel for the multiple output kernel.
%	 Returns:
%	  G1 - gradient of the parameters of the first kernel, for ordering
