...
%	Description:
%
%	[G1, G2] = HEATXHEATKERNGRADIENT(HEATKERN1, HEATKERN2, X1, COVGRAD)
%	computes the gardients wrt parameters of a cross kernel term between
...
%	   see simKernExtractParam.
%	 Arguments:
%	  HEATKERN1 - the kernel structure associated with the first HEAT
%	   kernel.
%	  HEATKERN2 - the kernel structure associated with the second HEAT
%	   kernel.
...
%
%	[G1, G2] = HEATXHEATKERNGRADIENT(HEATKERN1, HEATKERN2, X1, X2,
%	COVGRAD) computes cross kernel terms between two HEAT kernels for
