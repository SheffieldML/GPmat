...
%	Description:
%
%	[K, SK] = SIMXSIMKERNDIAGCOMPUTE(SIMKERN1, SIMKERN2, T) computes
%	diagonal of cross kernel terms between two SIM kernels for the
%	multiple output kernel.
%	 Returns:
%	  K - block of values from the diagonal kernel matrix.
%	  SK - normalised diagonal(i.e. unscaled version of K not multiplied
