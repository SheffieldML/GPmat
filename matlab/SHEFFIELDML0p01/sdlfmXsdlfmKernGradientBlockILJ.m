function [g1, g2, g3] = sdlfmXsdlfmKernGradientBlockILJ(lfmKern1, lfmKern2, ...
...
%	T1, T2, I, J, GENERALCONSTANT, GENERALCONSTGRAD, COVGRAD, G1MEAN,
%	G2MEAN, GSP1MEAN, GSP2MEAN, TYPEMEANPARAM, TYPEMEANSWITCHING,
%	TYPEKERNPARAM1, TYPEKERNPARAM2, TYPEKERNSWITCHING1,
%	TYPEKERNSWITCHING2) computes the gradients of the parameters for
%	system 1 and system 2 when i is lower than j.
%	 Returns:
