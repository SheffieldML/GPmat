...
%	Description:
%
%	LFMVISUALISEWALKING(MODEL, VISUALISEFUNCTION, VISUALISEMODIFY, ...)
...
%	Copyright (c) 2012 Mauricio Alvarez and Neil D. Lawrence
...
a = text(varargin{3}{1}(1), varargin{3}{2}(1), ' Motion 35')
set(a, 'horizontalalignment', 'left', 'color', [0 0 1], 'fontsize', 16) 
a = text(varargin{4}{1}(1), varargin{4}{2}(1), 'Motion 10')
...
visualiseInfo.varargin{1} = zeros(1, length(visualiseInfo.varargin{1}));
