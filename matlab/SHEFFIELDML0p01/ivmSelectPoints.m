...
%	Description:
%
%	MODEL = IVMSELECTPOINTS(MODEL, DISPLAY) is an alternative selection
%	approach to ivmOptimiseIvm. It performs EP style updates and point
%	swaps as well as point selection.
%	 Returns:
%	  MODEL - model structure with the active set selected.
%	 Arguments:
%	  MODEL - model for which the points are being selected.
%	  DISPLAY - whether or not to display the details of the
%	   optimisaiton (set to 0, 1 or 2, default value is 1).
%	ivmSelectVisualise, ivmRemovePoint, ivmEpUpdatePoint
%	
%
%	See also
%	IVMOPTIMISEIVM, IVMSELECTPOINT, IVMADDPOINT, 
