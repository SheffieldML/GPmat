...
%	   possible names are 'robotWireless', 'robotTwoLoops',
%	   'robotTraces', 'robotTracesTest', 'cmu35gplvm', 'cmu35Taylor',
%	   'cmu35walkJog', 'vowels', 'stick', 'brendan', 'digits', 'twos',
%	   'oil', 'oilTest', 'oilValid', 'oil100', 'swissRoll', 'missa'.
%	
%
%	See also
