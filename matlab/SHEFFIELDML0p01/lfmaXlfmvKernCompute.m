function K = lfmaXlfmvKernCompute(lfmKern1, lfmKern2, t1, t2)

% LFMAXLFMVKERNCOMPUTE Acceleration and velocity LFM kernel
%
%	Description:
%
%	K = LFMAXLFMVKERNCOMPUTE(LFMKERN1, LFMKERN2, T) computes cross
%	kernel terms between acceleration and velocity LFM kernels.
%	 Returns:
...
%
%	K = LFMAXLFMVKERNCOMPUTE(LFMKERN1, LFMKERN2, T1, T2) computes cross
...
sK =  lfmComputeH3AV(gamma1_p, gamma1_m, sigma2, t1,t2,preFactors([1 2]), 0) + ...
    lfmComputeH3AV(gamma2_p, gamma2_m, sigma2, t2,t1,preFactors([3 4]), 1).' + ...
    lfmComputeH4AV(gamma1_p, gamma1_m, sigma2, t1, preGamma([1 2 4 3]), preExp2, 0 ) + ...
    lfmComputeH4AV(gamma2_p, gamma2_m, sigma2, t2, preGamma([1 3 4 2]), preExp1, 1 ).';
