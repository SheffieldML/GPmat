...
%	Description:
%
%	[GENERALCONSTGRAD, GENERALCONSTANT] =
%	SDLFMKERNGRADIENTCONSTANT(NINTERVALS, LFMKERN1, LFMKERN2, SPVECTOR)
%	computes necessary gradients of the constants computed with
%	sdlfmKernComputeConstant.m
%	 Returns:
%	  GENERALCONSTGRAD - a cell containing the relative derivatives
