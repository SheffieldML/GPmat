...
%	Description:
%
%	IVMEPUPDATEM(MODEL, INDEX) performs an EP update on the IVM model's
%	represenations for a given point.
%	 Arguments:
%	  MODEL - the mode for which the update will be done.
%	  INDEX - the index of the point for which the update will take
%	   place.
%	
%
%	See also
%	IVMEPUPDATEPOINT, IVMDOWNDATESITES
