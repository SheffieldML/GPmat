function lfmResultsDynamicWalking(dataSet, number, dataType, varargin)

% LFMRESULTSDYNAMICWALKING Load a results file and visualise them.
%
%	Description:
%
%	LFMRESULTSDYNAMICWALKING(DATASET, NUMBER, DATATYPE, ...) loads
...
%	With modifications by Mauricio Alvarez 2012
...
switch model.nlf
 case 2
  lfmVisualiseWalking(model, [dataType 'Visualise'], [dataType 'Modify'], varargin{:});
