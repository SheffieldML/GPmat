 function g = mlpardKernDiagGradient(kern, x, covDiag)

% MLPARDKERNDIAGGRADIENT Compute the gradient of the MLPARD kernel's diagonal wrt parameters.
% FORMAT
% DESC computes the gradient of functions of the diagonal of the
% automatic relevance determination multi-layer perceptron kernel matrix with respect to the parameters of the kernel. The
% parameters' gradients are returned in the order given by the
% mlpardKernExtractParam command.
...
% mlpardKernExtractParam.
%
% SEEALSO : mlpardKernParamInit, kernDiagGradient, mlpardKernExtractParam, mlpardKernGradient
%
