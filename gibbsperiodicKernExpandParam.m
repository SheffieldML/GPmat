...
% FORMAT
% DESC returns a Gibbs-kernel derived periodic kernel structure filled with the
...
% relevant locations.
%
% SEEALSO : gibbsperiodicKernParamInit, gibbsperiodicKernExtractParam, kernExpandParam
%
