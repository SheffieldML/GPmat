MLTOOLS software
Version 0.134		Friday 06 Nov 2009 at 16:49
...
pmvuCreate.m: Create a PMVU model.
pmvuDeconstruct.m: break PMVU in pieces for saving.
pmvuDisplay.m: Display parameters of the PMVU model.
pmvuExpandParam.m: Create model structure from PMVU model's parameters.
pmvuExtractParam.m: Extract parameters from the PMVU model structure.
mvuReconstruct.m: Reconstruct an MVU form component parts.
pmvuLogLikeGradients.m: Gradient of PMVU model log likelihood with respect to parameters.
pmvuLogLikelihood.m: Log likelihood of PMVU model.
pmvuOptions.m: Create a default options structure for the PMVU model.
isomapDeconstruct.m: break isomap in pieces for saving.
pmvuParamInit.m: PMVU model parameter initialisation.
pmvuReconstruct.m: Reconstruct an probabilistic maximum variance unfolding from component parts.
