...
% between a white noise kernel and a dummy kernel.
...
%
% FORMAT
% DESC computes cross kernel terms between a white noise kernel and a
% dummy kernel for the multiple output kernel. 
% ARG whiteKern : the kernel structure associated with the 
% white noise kernel.
% ARG noneKern : the dummy kernel structure.
