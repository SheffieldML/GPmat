...
%	Description:
%
%	G = RBFHKERNGRADIENT(KERN, X1, COVGRAD) computes the gradient of
%	functions with respect to the radial basis function heat kernel's
...
%
%	G = RBFHKERNGRADIENT(KERN, X1, X2, COVGRAD) computes the derivatives
...
%
%	See also
%	RBFHKERNPARAMINIT, KERNGRADIENT
