...
%	'gaussian').
%
%	KERN = LMCKERNPARAMINIT(KERN, OPTIONS) initialises the linear model
%	of coregionalization kernel structure with some default parameters
%	for the initial conditions.
%	 Returns:
%	  KERN - the kernel structure with the default parameters placed in.
%	 Arguments:
%	  KERN - the kernel structure which requires initialisation.
%	  OPTIONS - options for the switching dynamical structure.
%	
%
%	See also
%	KERNCREATE, MULTIGPCREATE
