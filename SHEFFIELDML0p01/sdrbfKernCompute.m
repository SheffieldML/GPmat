...
%	Description:
%
%	[K, KC] = SDRBFKERNCOMPUTE(KERN, T1, T2) computes the kernel
%	matrices for the switching dynamical radial basis function kernel.
%	It is used together with the switching dynamical latent force model.
%	The kernel matrices are stored in a cell structure and each
%	component of the cell corresponds to the kernel matrix of a
%	particular sequence of latent forces.
%	 Returns:
%	  K - the kernel matrices computed at the given points.
%	  KC - the kernel matrices grouped in cells. Suitable form for the
%	   sparse approximations.
%	 Arguments:
%	  KERN - the kernel structure for which the matrix is computed.
%	  T1 - the input points associated with the rows of the kernel.
%	  T2 - the input points associated with the columns of the kernel.
%
%	[K, KC] = SDRBFKERNCOMPUTE(KERN, T1) computes the kernel matrices
%	for the switching dynamical radial basis function kernel. It is used
%	together with the switching dynamical latent force model. The kernel
%	matrices are stored in a cell structure and each component of the
%	cell corresponds to the kernel matrix of a particular sequence of
%	latent forces.
%	 Returns:
...
%	 Arguments:
%	  KERN - the kernel structure for which the matrix is computed.
%	  T1 - input data matrix in the form of a design matrix.
%	
%
%	See also
