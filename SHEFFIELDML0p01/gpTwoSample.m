...
%	Description:
%
%	LLRATIOS = GPTWOSAMPLE(T, Y) computes a two sample test using
%	independent or combined GPs to determine whether two gene expression
%	profiles were more likely to be independently generated or generated
%	together.
%	 Returns:
%	  LLRATIOS - the log likelihood ratio between the combined and
%	   independent models.
%	 Arguments:
%	  T - cell array containing times of the two gene expression
%	   profiles.
%	  Y - cell array containing log expression levels of the gene
%	   expression. In each component of the cell array different genes
%	   are in different columns and different time points in different
%	   rows.
%	
%
%	See also
%	MULTIMODELCREATE, GPCREATE
