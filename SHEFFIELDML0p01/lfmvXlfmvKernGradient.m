...
%	Description:
%
%	[G1, G2] = LFMVXLFMVKERNGRADIENT(LFMKERN1, LFMKERN2, T1, COVGRAD)
%	computes cross gradient of parameters of a cross kernel between two
%	lfm kernels, both of them correspond to the velocities.
%	 Returns:
...
%
%	[G1, G2] = LFMVXLFMVKERNGRADIENT(LFMKERN1, LFMKERN2, T1, T2,
...
%	kernel between two lfm kernels, both of them correspond to the
%	velocities.
%	 Returns:
%	  G1 - gradient of the parameters of the first kernel, for ordering
%	   see lfmKernExtractParam.
