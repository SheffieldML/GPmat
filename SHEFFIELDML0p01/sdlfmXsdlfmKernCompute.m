...
%	Description:
%
%	K = SDLFMXSDLFMKERNCOMPUTE(SDLFMKERN1, SDLFMKERN2, T, COVIC)
%	computes cross kernel terms between two switching dynamical LFM
...
%
%	K = SDLFMXSDLFMKERNCOMPUTE(SDLFMKERN1, SDLFMKERN2, T1, T2, COVIC)
%	computes cross kernel terms between two SDLFM kernels for the
...
%
%	K = SDLFMXSDLFMKERNCOMPUTE(SDLFMKERN1, SDLFMKERN2, T1, T2, COVIC,
%	TYPE) computes cross kernel terms between two SDLFM kernels for the
%	multiple output kernel. The SDLFM kernels can correspond to Position
