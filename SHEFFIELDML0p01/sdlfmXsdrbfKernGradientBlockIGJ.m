...
%	Description:
%
%	SDLFMXSDRBFKERNGRADIENTBLOCKIGJ(LFMKERN, RBFKERN, T1, T2, I, J, I,
%	J, GENERALCONSTANT, GENERALCONSTGRAD, COVGRAD, TYPEMEANGRAD)
%	computes the gradients of the parameters for output system and
...
%	   system
%	  T1 - times at which the output system is evaluated
%	  T2 - times at which the LF system is evaluated
%	  I - interval in which the output is evaluated
%	  J - interval in which the latent force is being evaluated
...
%	  TYPEMEANGRAD - specify the mean functions used to compute this
%	   part of the kernel
