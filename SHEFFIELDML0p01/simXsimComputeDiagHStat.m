...
%
%	H = SIMXSIMCOMPUTEDIAGHSTAT(T, DECAY1, DECAY2, L) computes a portion
%	of the stationary version of the diagonal of he SIM kernel.
%	 Returns:
...
%
%	See also
%	SIMXSIMCOMPUTEDIAGH, SIMKERNPARAMINIT, LNDIFFERFS
