...
%	Description:
%
%	KERN = SDLFMKERNPARAMINIT(KERN)  Initializes the switching dynamical
%	latent force model kernel structure with some initial parameters.
%	The initial parameters are passed through an option in kern.
%	 Returns:
...
%
%	See also
%	KERNCREATE, KERNPARAMINIT, LFMKERNPARAMINIT
