function K = lfmvXlfmvKernCompute(lfmKern1, lfmKern2, t1, t2)

% LFMVXLFMVKERNCOMPUTE Velocity and velocity LFM kernel
%
%	Description:
%
%	K = LFMVXLFMVKERNCOMPUTE(LFMKERN1, LFMKERN2, T) computes cross
%	kernel terms between velocity and velocity LFM kernels.
%	 Returns:
...
%
%	K = LFMVXLFMVKERNCOMPUTE(LFMKERN1, LFMKERN2, T1, T2) computes cross
...
sK = lfmComputeH3VV(gamma1_p, gamma1_m, sigma2, t1,t2,preFactors([1 2]), 1) + ...
    ...
    lfmComputeH4VV(gamma2_p, gamma2_m, sigma2, t2, preGamma([1 3 4 2]), preExp1 ).';
