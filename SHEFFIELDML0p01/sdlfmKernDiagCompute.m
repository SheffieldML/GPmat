...
%	Description:
%
%	K = SDLFMKERNDIAGCOMPUTE(SDLFMKERN, T, TYPE) computes the diagonal
%	of the kernel matrix for the switching dynamical latent force model
%	kernel given a design matrix of inputs.
%	 Returns:
%	  K - a vector containing the diagonal of the kernel matrix computed
%	   at the given points.
%	 Arguments:
%	  SDLFMKERN - the kernel structure for which the matrix is computed.
%	  T - input data matrix in the form of a design matrix.
%	  TYPE - specifies the type of diagonal kernel to compute. Options
%	   are 'PosPos' (default), 'VelVel' and 'AccelAccel'.
%	
%
%	See also
%	SDLFMKERNPARAMINIT, KERNDIAGCOMPUTE, KERNCREATE
