function [g1, g2, g3] = sdlfmvXsdlfmvKernGradientBlock(lfmKern1, lfmKern2, ...
...
%	Description:
%
%	[G1, G2, G3] = SDLFMVXSDLFMVKERNGRADIENTBLOCK(LFMKERN1, LFMKERN2,
...
%	the computation for functions that both systems describe velocities.
%	 Returns:
...
[g1Mean, g2Mean, gsp1Mean, gsp2Mean] = sdlfmKernGradientMean(lfmKern1(1), ...
    lfmKern2(1), t1, t2, kyy, kyv, kvy, kvv, covGrad, {'sdlfmv','sdlfmv'}, ...
    {'sdlfma', 'sdlfma'});

if i==j
    [g1, g2, g3t] = sdlfmXsdlfmKernGradientBlockIEJ(lfmKern1, lfmKern2, t1, ...
        t2, covGrad, g1Mean, g2Mean, gsp1Mean, gsp2Mean, {'lfmv', 'lfmv'}, ...
        {'lfma', 'lfmv'}, {'lfma', 'lfmv'});
    g3(i) = g3t;
else
    if i>j
        [g1, g2, g3] = sdlfmXsdlfmvKernGradientBlockIGJ(lfmKern1, lfmKern2, ...
            ...
            g2Mean, gsp1Mean, gsp2Mean, 'sdlfmv', 'sdlfma', 'lfmvXlfm', ...
