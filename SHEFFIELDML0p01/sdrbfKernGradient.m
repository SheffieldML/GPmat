...
%	Description:
%
%	G = SDRBFKERNGRADIENT(KERN, T, COVGRAD) computes the gradient of
%	functions with respect to the switching dynamical radial basis
%	function kernel's parameters. As well as the kernel structure and
...
%
%	G = SDRBFKERNGRADIENT(KERN, T1, T2, COVGRAD) computes the
