...
%	Description:
%
%	KERN = SDRBFKERNPARAMINIT(KERN)  Initializes the switching dynamical
%	latent force model structure with some initial parameters for the
%	RBF underlying kernels. The initial parameters are passed through an
%	option in kern.
%	 Returns:
...
%
%	See also
%	KERNCREATE, KERNPARAMINIT, RBFKERNPARAMINIT
