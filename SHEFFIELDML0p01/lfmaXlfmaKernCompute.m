...
%	Description:
%
%	K = LFMAXLFMAKERNCOMPUTE(LFMKERN1, LFMKERN2, T) computes cross
%	kernel terms between acceleration and acceleration LFM kernels.
%	 Returns:
...
%
%	K = LFMAXLFMAKERNCOMPUTE(LFMKERN1, LFMKERN2, T1, T2) computes cross
...
sK = lfmComputeH3AA(gamma1_p, gamma1_m, sigma2, t1,t2,preFactors([1 2]), 0) + ...
    lfmComputeH3AA(gamma2_p, gamma2_m, sigma2, t2,t1,preFactors([3 4]), 1).' + ...
    lfmComputeH4AA(gamma1_p, gamma1_m, sigma2, t1, preGamma([1 2 4 3]), preExp2, 0 ) + ...
    lfmComputeH4AA(gamma2_p, gamma2_m, sigma2, t2, preGamma([1 3 4 2]), preExp1, 1 ).';
