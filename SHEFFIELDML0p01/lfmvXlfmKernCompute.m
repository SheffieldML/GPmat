function K = lfmvXlfmKernCompute(lfmKern1, lfmKern2, t1, t2)

% LFMVXLFMKERNCOMPUTE Velocity and position LFM kernel
%
%	Description:
%
%	K = LFMVXLFMKERNCOMPUTE(LFMKERN1, LFMKERN2, T) computes cross kernel
%	terms between velocity and position LFM kernels.
%	 Returns:
...
%
%	K = LFMVXLFMKERNCOMPUTE(LFMKERN1, LFMKERN2, T1, T2) computes cross
...
preExp1(:,1) = gamma1_p.*exp(-gamma1_p*t1);
preExp1(:,2) = gamma1_m.*exp(-gamma1_m*t1);
preExp2(:,1) = exp(-gamma2_p*t2);
preExp2(:,2) = exp(-gamma2_m*t2);
% Actual computation of the kernel

sK = lfmComputeH3VP(gamma1_p, gamma1_m, sigma2, t1,t2,preFactors([1 2]), 0) + ...
    lfmComputeH3VP(gamma2_p, gamma2_m, sigma2, t2,t1,preFactors([3 4]), 1).' + ...
    lfmComputeH4VP(gamma1_p, gamma1_m, sigma2, t1, preGamma([1 2 4 3]), preExp2, 0 ) + ...
    lfmComputeH4VP(gamma2_p, gamma2_m, sigma2, t2, preGamma([1 3 4 2]), preExp1, 1 ).';
