...
%	Description:
%
%	[G1, G2] = LFMVXLFMKERNGRADIENT(LFMKERN1, LFMKERN2, T1, COVGRAD)
%	computes cross gradient of parameters of a cross kernel between two
%	lfm kernels, one lfm kernel corresponds to the velocity and the
%	other corresponds to the position. It is supposed to be used
...
%
%	[G1, G2] = LFMVXLFMKERNGRADIENT(LFMKERN1, LFMKERN2, T1, T2, COVGRAD)
%	computes cross gradient of parameters of a cross kernel between two
%	lfm kernels, one lfm kernel corresponds to the velocity and the
%	other corresponds to the position. It is supposed to be used
%	together with the multiple output kernel.
...
%
%	[G1, G2] = LFMVXLFMKERNGRADIENT(LFMKERN1, LFMKERN2, T1, T2, COVGRAD,
%	MEANVEC) computes cross gradient of parameters of a cross kernel
%	between two lfm kernels, one lfm kernel corresponds to the velocity
%	and the other corresponds to the position. It is supposed to be used
%	together with the multiple output kernel.
%	 Returns:
%	  G1 - gradient of the parameters of the first kernel, for ordering
%	   see lfmKernExtractParam.
