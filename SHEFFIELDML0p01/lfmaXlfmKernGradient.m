function [g1, g2] = lfmaXlfmKernGradient(lfmKern1, lfmKern2, t1, t2, covGrad, meanVector)

% LFMAXLFMKERNGRADIENT Compute a cross gradient between a LFMA and a LFM.
%
%	Description:
%
%	[G1, G2] = LFMAXLFMKERNGRADIENT(LFMKERN1, LFMKERN2, T1, COVGRAD)
...
%	corresponds to the position. It is supposed to be used together with
...
%
%	[G1, G2] = LFMAXLFMKERNGRADIENT(LFMKERN1, LFMKERN2, T1, T2, COVGRAD)
%	computes cross gradient of parameters of a cross kernel between two
%	lfm kernels, one lfm kernel corresponds to the accel. and the other
%	corresponds to the position. It is supposed to be used together with
%	the multiple output kernel.
