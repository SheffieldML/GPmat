...
%	Description:
%
%	H = SIMXSIMCOMPUTEDIAGH(T, DECAY1, DECAY2, DELAY1, DELAY2, L)
%	computes a portion of the SIM kernel.
%	 Returns:
%	  H - result of this subcomponent of the kernel for the given
%	   values.
%	 Arguments:
%	  T - time input (number of time points x 1).
%	  DECAY1 - Decay rate for first system.
%	  DECAY2 - Decay rate for second system.
%	  DELAY1 - Delay for first system.
%	  DELAY2 - Delay for second system.
