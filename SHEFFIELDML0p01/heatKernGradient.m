...
%	Description:
%
%	G = HEATKERNGRADIENT(KERN, X, PARTIAL) computes the gradient of
%	functions with respect to the heat kernel's parameters. As well as
...
%
%	G = HEATKERNGRADIENT(KERN, X1, X2, PARTIAL) computes the derivatives
